...
export default class AVLTree extends BinarySearchTree {
  ...
  getBalanceFactor(node) {
    ...
    switch (heightDifference) {
      ...
      case 1:
        return BalanceFactor.SLIGHTLY_UNBALANCED_LEFT; //! 3 
      case 2:
        return BalanceFactor.UNBALANCED_LEFT; //! 4
      default:
  ...
  insertNode(node, key) {
    ...
    if (balanceFactor === BalanceFactor.UNBALANCED_LEFT) { //! 4 --> 2
  ...
  removeNode(node, key) {
    ...
    if (balanceFactor === BalanceFactor.UNBALANCED_LEFT) { //! 4 --> 2
      ...
      if (
        ...
        this.getBalanceFactor(node.left) === BalanceFactor.SLIGHTLY_UNBALANCED_LEFT //! 3 --> 1
      ) {
        return this.rotationLL(node);
      }
      // Left right case
    ...
    if (balanceFactor === BalanceFactor.UNBALANCED_RIGHT) {  //! 1  --> -2 
      ...
      // Right left case
      if (this.getBalanceFactor(node.right) === BalanceFactor.SLIGHTLY_UNBALANCED_LEFT) { //! 3 --> 1
